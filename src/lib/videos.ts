...
export const VIDEOS: Video[] = [
  ...
  { id: "million-praise", title: "A Million Praise", speaker: "UCC Worship", img: featurePraise, duration: "1:12:04", category: "Workshops", tab: "Series", description: "An evening of worship gathering thousands of voices lifted in praise.", videoUrl: "/videos/a-million-praise.mov" },
  ...
  { id: "push-em", title: "Push Em", speaker: "UCC Worship", img: featureYouth, duration: "4:15", category: "Inspirational", tab: "Watch Now", description: "Official music video for Push Em by UCC Worship.", videoUrl: "/videos/push-em.m4v" },
  { id: "official-win", title: "Official Win Music Video", speaker: "UCC Worship", img: featurePraise, duration: "4:45", category: "Inspirational", tab: "Watch Now", description: "Official Win Music Video by UCC Worship.", videoUrl: "/videos/official-win-music-video-1080.mov" },
